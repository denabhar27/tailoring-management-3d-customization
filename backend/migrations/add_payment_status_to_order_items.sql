...
ADD COLUMN payment_status ENUM('unpaid', 'paid', 'cancelled', 'fully_paid', 'down-payment', 'partial_payment', 'pending', 'partial', 'refunded') DEFAULT 'unpaid' AFTER approval_status;
